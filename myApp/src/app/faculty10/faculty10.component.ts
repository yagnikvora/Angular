...
@Component({
  selector: 'app-faculty10',
  templateUrl: './faculty10.component.html',
  styleUrl: './faculty10.component.css'
})
export class Faculty10Component {
  faculty = [
    {
      "id": "1",
  ...
  faculties = this.faculty.filter((fac)=>{
    return parseInt(fac.FacultyExperience.split("+")[0]) > 10;
  })
